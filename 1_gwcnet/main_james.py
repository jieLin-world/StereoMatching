...
parser.add_argument('--datapath', default="/media/jamesdrive/stereodata", help='data path')
...
parser.add_argument('--lrepochs',default="300:2", type=str,  help='the epochs to decay lr: the downscale rate')  # 200, 400

parser.add_argument('--logdir', default='./checkpoint2', help='the directory to save logs and checkpoints')
parser.add_argument('--loadckpt', help='load the weights from a specific checkpoint')
#parser.add_argument('--loadckpt', default='./danet_sceneflow/checkpoint_000063.ckpt', help='load the weights from a specific checkpoint')
...
def train():
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        # # testing
            ...
            with open("dsgnet2.txt", "a") as file:
